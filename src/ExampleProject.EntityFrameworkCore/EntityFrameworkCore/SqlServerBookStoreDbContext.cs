...
public class SqlServerBookStoreDbContext :
    AbpDbContext<SqlServerBookStoreDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public SqlServerBookStoreDbContext(DbContextOptions<SqlServerBookStoreDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(ExampleProjectConsts.DbTablePrefix + "Authors",
